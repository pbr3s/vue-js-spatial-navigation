...
;(function($) {
  ...
  function onKeyDown(evt) {
    ...
    var direction = GlobalConfig.keyMap.arrow[evt.keyCode];
    if (!direction) {
      if (GlobalConfig.keyMap[evt.keyCode] === 'enter') {
  ...
  function onKeyUp(evt) {
    ...
    if (!_pause && _sectionCount &&  GlobalConfig.keyMap[evt.keyCode] == 'enter') {
      var currentFocusedElement = getCurrentFocusedElement();
      if (currentFocusedElement && getSectionId(currentFocusedElement)) {
